...
open class LockallyAPIConfiguration: @unchecked Sendable {
    ...
    public static let shared = LockallyAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: LockallyAPIConfiguration
    ...
    required public init(
        ...
        apiConfiguration: LockallyAPIConfiguration = LockallyAPIConfiguration.shared
    ) {
        self.method = method
